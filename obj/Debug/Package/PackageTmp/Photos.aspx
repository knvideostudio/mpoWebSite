<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Photos.aspx.cs" Inherits="mpoWebSite.Photos" %>
...
<title>TSClub 5849 - Photos.</title>
  ...
  <tr>
    ...
    <table border="0" cellpadding="10" style="border-collapse: collapse;"  width="100%">
      ...
      <tr>
        ...
        <span class="tl1">TSClub 5849 Photos</span><br />
	     <h2>Vivian in Summer Conference 2011</h2>
			<img alt="" src="mpo3/vivian1.jpg" width="850" height="565" /><br />
			<br />
			 <h2>Vivian with the banner of MPO Club</h2>			
			 <img alt="" src="mpo3/vivian2.jpg" width="850" height="713" /><br />
		<br />
			<h2>Vivian and Ida</h2>
			<img alt="" src="mpo3/vivian3.jpg" width="850" height="648" /><br />
