<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="faq.aspx.cs" Inherits="mpoWebSite.faq" %>
...
<title>TSClub 5849 - Frequently Asked Questions.</title>
  ...
  <tr>
    ...
    <table border="0" cellpadding="10" style="border-collapse: collapse;"  width="100%">
      ...
      <tr>
        ...
        <span class="tl1">Frequently Asked Questions</span><br />
      <br />
      <ul>
          <li>What are the tracks in Toastmasters?
          <br />Communication Track and Leadership Track, refer to the manuals, 
			each section had a different requirements. <br />
			<img alt="DTM Track" src="mpo3/track3.jpg" width="850" height="487" /><br />
&nbsp;<br />
          </li>
          <li>Is there are a manual for speeches?<br />
          Yes, it. The first manual contains 10 speeches with different goals. With every speech you achieve different skills. 
          <br />
          These are the speech description from the manual: <br />
          1. The Ice Breaker; 2. Organize Your Speech; 3. Get to the Point; 4. How to Say It; 
          5. Your Body Speaks; 6. Vocal Variety; 7. Research Your Topic; 8. Get Comfortable with Visual Aids;
          9. Persuade with Power; 10. Inspire your Audience
          <br />
          </li>
