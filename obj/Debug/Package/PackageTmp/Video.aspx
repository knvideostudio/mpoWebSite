<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Video.aspx.cs" Inherits="mpoWebSite.Video" %>
...
<title>TSClub 5849 - Videos.</title>
  ...
  <tr>
    ...
    <table border="0" cellpadding="10" style="border-collapse: collapse;"  width="100%">
      ...
      <tr>
        ...
        <span class="tl1">Videos 2012, 2013, 2014</span><br />
      <br />
            Latest Videos.<br />
        <iframe title="video" class="youtube-player" width="450" height="350" 
            src="http://www.youtube.com/embed/Oi4ewu0AL2U" frameborder="0"></iframe>
		<iframe title="video" class="youtube-player" width="450" height="350" 
            src="http://www.youtube.com/embed/Zg8lZCpKz9k" frameborder="0"></iframe>
            <hr style="border: 3px;" />
        <br />

      Toastmasters is the best kept secret in the world. Cobb Communicator June 26, 2012.
      <br />
  <iframe title="video" class="youtube-player" width="450" height="350" 
            src="http://www.youtube.com/embed/xo6IO8GgFAc" frameborder="0"></iframe>
            <iframe title="video" class="youtube-player" width="450" height="350" 
            src="http://www.youtube.com/embed/6-7EG2j1lK8" frameborder="0"></iframe>
		    <br />
		<hr style="border: 3px;" />
     <iframe title="video" class="youtube-player" width="450" height="350" 
            src="http://www.youtube.com/embed/5xNOGfmTTyk" frameborder="0"></iframe>
