<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Schedule.aspx.cs" Inherits="mpoWebSite.Schedule" %>
...
<title>TSClub 5849 - Schedule.</title>
  ...
  <tr>
    ...
    <table border="0" cellpadding="10" style="border-collapse: collapse;"  width="100%">
      ...
      <tr>
        ...
        <span class="tl1">TSClub 5849 Weekly Schedule</span>		<br />
      <br />
<br />
<br />

  <form name="LoginForm" method="POST" action="http://www.turbobase.com/talk/login">
  <input type="hidden" name="formEmpty" value="true" />
  <input type="hidden" name="formUsed" value="Login" />
    <table border="0">
      <tr><th colspan="2" align="left" bgcolor="#E9E9FA">Login at Turbobase:</th></tr>
 
      <tr><td nowrap align="right" valign="top">Email Address</td>
        <td nowrap align="left" valign="top">
		<input type="text" name="emailAddress" maxlength="255" size="20" style="width: 149px"  /></td></tr>
          
      <tr><td nowrap align="right" valign="top">Password</td>
      <td nowrap align="left" valign="top">
		<input type="password" name="password" maxlength="20" size="20" style="width: 149px"  /></td></tr>
      ...
      <input type="submit" value="Login" /></td></tr>
		...
		<br /><br />
		You will go to another web site to view the schedule it will require password and user name.
		</td>
